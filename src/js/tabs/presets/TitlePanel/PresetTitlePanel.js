export default class PresetTitlePanel
{
    ...
    _updateHoverEffects() {
        ...
        if (this._clickable && this._mouseOnPanel && !this._mouseOnStar) {
            this._domWrapperDiv.css({"background-color": "var(--darkAccent)"});
        } else {
            this._domWrapperDiv.css({"background-color": "var(--backgroundColor)"});
        }

        if (this._mouseOnStar || (this._mouseOnPanel && this._clickable)) {
            this._domStar.css({"background-color": "var(--darkAccent)"});
            starMouseHover = true;
        } else {
            this._domWrapperDiv.css({"background-color": "var(--backgroundColor)"});
            this._domStar.css({"background-color": "var(--backgroundColor)"});
        }
