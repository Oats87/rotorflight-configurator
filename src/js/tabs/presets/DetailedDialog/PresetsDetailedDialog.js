...
export default class PresetsDetailedDialog {
    ...
    _getFinalCliText() {
        ...
        return this._presetsRepo._PresetParser.renderPreset(this._preset.originalPresetCliStrings, optionsToInclude);
    }
    ...
    _createOptionsSelect(options) {
        ...
        options.forEach(option => {
            if (!option.options) {
                data.push(this._msOption(option))
            } else {
                data.push(this._msOptionGroup(option))
            }
        });
    ...
    _ensureMutuallyExclusiveOptions(view) {
        ...
        if (group.isExclusive) {
            ...
            this._domOptionsSelect.multipleSelect('setSelects', newCheckedValues);
        }
    }
